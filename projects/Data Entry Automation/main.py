...
# Your Chrome Path
edgs_path = "C:\Windows\SystemApps\Microsoft.MicrosoftEdge_8wekyb3d8bbwe"
...
class HouseData:
    def __init__(self):
        #Creating EdgsOptions and specifiying the webDriver executable path
        edge_option = webdriver.EdgeOptions()
        edge_option.binary_location = edgs_path
        self.driver = webdriver.Edge(options=edgs_path)
